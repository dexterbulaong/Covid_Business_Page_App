...
public class Groc_search extends Fragment {
    ...
    public View onCreateView(
        ...
        View v = inflater.inflate(R.layout.groc_layout, container, false);

        Call<Category_Response> call = RetrofitClient.getInstance().getApi().getBusinesses("Grocery and Pharmacy");
                ...
                for(int i = 0; i < businessList.size(); i++) {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            ...
                            NavHostFragment.findNavController(Groc_search.this)
                                    .navigate(R.id.action_groc_search_to_Business_Temp, bundle);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.back_to_Category).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(Groc_search.this)
                        .navigate(R.id.action_groc_search_to_CategNav);
            }
        });
