...
public class Restaurant_search extends Fragment {
    ...
    public View onCreateView(
        ...
        View v = inflater.inflate(R.layout.rest_layout, container, false);

        Call<Category_Response> call = RetrofitClient.getInstance().getApi().getBusinesses("Food and Restaurant");
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            ...
                            NavHostFragment.findNavController(Restaurant_search.this)
                                    .navigate(R.id.action_restaurant_search_to_Business_Temp, bundle);
